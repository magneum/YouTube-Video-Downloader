...
def just_get_message(_,𝐓𝐮𝐛𝐞: Message):
    𝐓𝐮𝐛𝐞.delete()
    𝐓𝐮𝐛𝐞.reply_chat_action("record_video")
    Video_Hole = HV_YouTube_Video.extract_info(𝐓𝐮𝐛𝐞.text)
    if Video_Hole['duration'] > 1800:
        𝐓𝐮𝐛𝐞.reply_photo("https://telegra.ph/file/afbe2788479c6d7a30678.jpg",
        caption=f"""
一═デ 𝐘𝐨𝐮𝐓𝐮𝐛𝐞🎬𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐫 デ═一
||
||
...
一═デ 𝐘𝐨𝐮𝐓𝐮𝐛𝐞🎬𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐫 デ═一""")
        return
    just_get_Message(𝐓𝐮𝐛𝐞, Video_Hole)   

def just_get_Message(𝐓𝐮𝐛𝐞: Message, Video_Hole):
    𝐓𝐮𝐛𝐞.reply_chat_action("record_audio")
    HV_YouTube_Video.process_info(Video_Hole)
    video_file = HV_YouTube_Video.prepare_filename(Video_Hole)
    video_sender(𝐓𝐮𝐛𝐞, Video_Hole,video_file)
...
def video_sender(𝐓𝐮𝐛𝐞: Message, Video_Hole, video_file):
